...
const (
	Favorite_Favorite_FullMethodName = "/favorite.Favorite/favorite"
)
...
func (c *favoriteClient) Favorite(ctx context.Context, in *FavoriteActionRequest, opts ...grpc.CallOption) (*FavoriteActionResponse, error) {
	out := new(FavoriteActionResponse)
	err := c.cc.Invoke(ctx, Favorite_Favorite_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FavoriteServer interface {
	Favorite(context.Context, *FavoriteActionRequest) (*FavoriteActionResponse, error)
...
func (UnimplementedFavoriteServer) Favorite(context.Context, *FavoriteActionRequest) (*FavoriteActionResponse, error) {
...
func _Favorite_Favorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Favorite_Favorite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoriteServer).Favorite(ctx, req.(*FavoriteActionRequest))
	}
