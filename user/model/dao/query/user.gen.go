...
type user struct {
	...
	ALL             field.Asterisk
	ID              field.Int32
	Username        field.String // 注册用户名，最长32个字符
	Name            field.String // 用户昵称
	Password        field.String // 密码，最长32个字符
	Avatar          field.String
...
func (u userDo) Create(values ...*model.User) (error, error) {
	if len(values) == 0 {
		return nil, nil
	}
	return u.DO.Create(values), nil
}
...
func (u userDo) Last(*model.User) (*model.User, error) {
