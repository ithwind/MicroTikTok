...
func newUserFollow(db *gorm.DB, opts ...gen.DOOption) userFollow {
	...
	_userFollow.FollowerID = field.NewInt32(tableName, "follower_id")
	_userFollow.FollowedID = field.NewInt32(tableName, "followed_id")
...
func (u *userFollow) updateTableName(table string) *userFollow {
	...
	u.FollowerID = field.NewInt32(table, "follower_id")
	u.FollowedID = field.NewInt32(table, "followed_id")
...
func (u userFollow) Columns(cols ...field.Expr) gen.Columns { return u.userFollowDo.Columns(cols...) }
